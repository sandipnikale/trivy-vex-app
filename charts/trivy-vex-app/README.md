...
This chart deploys the **Rancher VEX Scanner**, a modern web application designed to orchestrate container image scans using Trivy and cross-reference findings with Rancher-specific VEX (Vulnerability Exploitability eXchange) reports.
...
---
Developed with ❤️ for the Rancher community.
